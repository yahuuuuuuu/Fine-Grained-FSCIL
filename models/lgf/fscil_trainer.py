...
class FSCILTrainer(Trainer):
    ...
    def train(self):
        ...
        for session in range(args.start_session, args.sessions):
            ...
            # print("Replace the clip fc with average embedding")
            # self.model = replace_clip_fc(train_set, testloader.dataset.transform,
            #                                      self.model, args,session)
            self.model.mode = 'ft_cos'
            if session == 0:  # load base class train img label
                ...
                for epoch in range(args.epochs_base):
                    ...
                    # train base sess
                    tl, ta = base_train(self.model, criterion, trainloader, optimizer, scheduler, epoch,
                                        args)
                ...
                if not args.not_data_init:
                    ...
                    self.model = replace_base_fc(train_set, testloader.dataset.transform,
                                                 self.model, args)
